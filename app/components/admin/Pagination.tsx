    ...
    <div className="flex items-center justify-between px-2 py-3">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-2 rounded-full hover:bg-rose-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors duration-200"
        >
            ...
            <button
              ...
              className={`min-w-[36px] h-9 rounded-full text-sm font-semibold transition-all duration-200 ${
                page === currentPage
                  ...
                  : "text-gray-600 hover:bg-rose-50 hover:text-[#F46A6A]"
              }`}
            >
              {page}
            </button>
