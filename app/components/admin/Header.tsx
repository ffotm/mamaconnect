    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 h-16 flex items-center justify-between px-4 lg:px-8 transition-shadow duration-300">
      ...
      <div className="flex items-center gap-3">
        <button className="relative p-2 rounded-lg hover:bg-gray-100 transition-colors duration-200">
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#F46A6A] rounded-full" />
        </button>
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-rose-50 flex items-center justify-center">
            <span className="text-[#F46A6A] font-semibold text-sm">BO</span>
          </div>
          <div className="hidden md:block">
            <p className="text-sm font-semibold text-gray-900 leading-tight">Blessing Okafor</p>
